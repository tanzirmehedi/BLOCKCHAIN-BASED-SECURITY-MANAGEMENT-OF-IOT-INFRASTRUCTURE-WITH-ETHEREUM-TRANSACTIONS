# IoT backend with Ethereum Transaction

### Using Ethereum Transaction of an IoT backend
* IoT gateways, which are relatively powerful devices, may be used to push collected data to file storage network via HTTP.
